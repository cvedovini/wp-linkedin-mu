...
define('WP_LINKEDIN_MU_PLUGIN_VERSION', '1.7.2');
...
function wp_linkedin_mu_filter_url() {
	$removable_query_args = apply_filters('removable_query_args', array('source', 'oauth_status', 'oauth_message'));
