...
function wp_linkedin_co_plugin_updater() {
	// retrieve our license key from the DB
	$license_key = trim(get_option('wp-linkedin-co_license_key'));

	// setup the updater
	$edd_updater = new EDD_SL_Plugin_Updater(WP_LINKEDIN_CO_STORE_URL, __FILE__, array(
...
add_action( 'admin_init', 'wp_linkedin_co_plugin_updater' );


function wp_linkedin_co_license_menu() {
	add_settings_section('licensing', __('License Keys', 'wp-linkedin-co'), '', 'wp-linkedin');
...
add_action('admin_init', 'wp_linkedin_co_activate_license');
...
add_action('admin_init', 'wp_linkedin_co_deactivate_license');
