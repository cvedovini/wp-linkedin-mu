...
<div class="heading"><?php _e('Volunteer Experiences', 'wp-linkedin-at'); ?></div>
...
<div class="volunteer">
	<div class="role"><strong><?php echo $v->role; ?></strong><?php if (isset($v->startDate)): ?>
		(<?php echo $v->startDate->year; ?> - <?php echo isset($v->endDate) ? $v->endDate->year : __('Present', 'wp-linkedin-at'); ?>)
	<?php endif; ?></div>
