...
$wp_linkedin_mu_license_key = trim(get_option('wp-linkedin-mu_license_key'));

// setup the updater
$wp_linkedin_mu_updater = new EDD_SL_Plugin_Updater(WP_LINKEDIN_MU_STORE_URL,
	'wp-linkedin-mu/wp-linkedin-mu.php', array(
		'version' 	=> WP_LINKEDIN_MU_VERSION,   	// current version number
		'license' 	=> $wp_linkedin_mu_license_key, // license key (used get_option above to retrieve from DB)
...
function wp_linkedin_mu_license_menu() {
	add_settings_section('licensing', __('License Keys', 'wp-linkedin-mu'), false, 'wp-linkedin');
...
add_action('admin_menu', 'wp_linkedin_mu_activate_license');
...
add_action('admin_menu', 'wp_linkedin_mu_deactivate_license');
